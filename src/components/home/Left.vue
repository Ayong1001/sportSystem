...
const homeBtn1 = () => {
  if (!isPieBtn.value) {
    echarts.init(document.getElementById('homePie')).setOption(myChartOption3)
    isPieBtn.value = !isPieBtn.value
  } else {
    echarts.init(document.getElementById('homePie')).setOption(myChartOption1)
    isPieBtn.value = !isPieBtn.value
  }
}
const homeBtn2 = () => {
  if (!isBarBtn.value) {
    echarts.init(document.getElementById('homeBar')).setOption(myChartOption2)
    isBarBtn.value = !isBarBtn.value
  } else {
    echarts.init(document.getElementById('homeBar')).setOption(myChartOption4)
    isBarBtn.value = !isBarBtn.value
  }
}
...
<template>
  <div class="mainLift">
    <div class="mainLiftTop">
      <div class="title">
        <img class="leftTip" src="../../assets/img/home/sexBG.png" alt="" />
        <img
          class="rightChange"
          @click="homeBtn1()"
    ...
    <div class="mainLiftButtom">
      <div class="title">
        <img class="leftTip" src="../../assets/img/home/ageBG.png" alt="" />
        <img
          class="rightChange"
          @click="homeBtn2()"
          src="../../assets/img/common/change.png"
